...
<html lang="en">
  <head>
    ...
    <title>เก็บข้อมูลลูกค้า NT</title>
  </head>
  <body>
    ...
    <div class="container">
      <h1 class="text-center">รายชื่อลูกค้าทั้งหมด</h1>
      <form action="searchdata.php" class="form-group my-3" method="POST">
        <div class="row">
          <div class="col-6">
            <input type="text" placeholder="กรอกชื่อลูกค้าที่ต้องการค้นหา" class="form-control" name="emp_data"  Required>
          </div>
          <div class="col-6">
            <input type="submit" value="ค้นหาข้อมูลลูกค้า" class="btn btn-info">
